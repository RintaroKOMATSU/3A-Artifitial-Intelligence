...
void setting(bool& is3D, std::string& inputArray, int& generations, int& population, int& maxTrials, std::string defaultInputArray, int defaultGenerations, int defaultPopulation, int defaultMaxTrials) {
    for (int i = 0; i < 20; i++) {
        std::cout << "\n";
    }
    std::cout << "\033[20A";
    ...
    // std::cout << "            \\ (     ) /                   ______   _______  _______ " << std::endl;
    // std::cout << " ____________(%%%%%%%)____________       (  ___ \\ (  ____ \\(  ____ \\" << std::endl;
    // std::cout << "(     /   /  )%%%%%%%(  \\   \\     )      | (   ) )| (    \\/| (    \\/" << std::endl;
    // std::cout << "(___/___/__/           \\__\\___\\___)      | (__/ / | (__    | (__    " << std::endl;
    // std::cout << "   (     /  /(%%%%%%%)\\  \\     )         |  __ (  |  __)   |  __)" << std::endl;
    // std::cout << "    (__/___/ (%%%%%%%) \\___\\__)          | (  \\ \\ | (      | (      " << std::endl;
    // std::cout << "            /(       )\\                  | )___) )| (____/\\| (____/\\" << std::endl;
    // std::cout << "          /   (%%%%%)   \\                |/ \\___/ (_______/(_______/" << std::endl;
    // std::cout << "               (%%%)                          " << std::endl;
    // std::cout << "                 !                            " << std::endl;
    ...
    std::cout << "                    -> " << decodedInput << std::endl;
